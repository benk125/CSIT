...
if __name__ == "__main__":
    ...
    if boolean_ben == True:
        #myprop_name = sys.stdin.readline().rstrip("\n") 
        server.set_endpoint("opc.tcp://admin@localhost:4840/freeopcua/server/" )
        #testing_var = fuzzable_module.process_data(myprop_name)
        server.set_server_name("Ben Server")
